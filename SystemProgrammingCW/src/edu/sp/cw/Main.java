...
public class Main {
    public static void main(String[] args) throws FileNotFoundException{
        ...
        String matrixFileName = String.format("src/edu/sp/cw/matrixes/%s_%dx%d.txt", method, dimensity, dimensity);
        MatrixReader matrixReader = new MatrixReader(matrixFileName, numberOfTasks);
        Topology topology = new HypercubeTopology(numberOfProcessor, topologyName);
