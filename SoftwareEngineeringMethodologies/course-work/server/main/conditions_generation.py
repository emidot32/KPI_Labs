"""Module generates conditions for task10"""
import random
...
def get_conditions():
    """Get possible spaces between ships"""
    hor_spaces = {}
    ver_spaces = {}
    ...
    while not is_appropriate:
        ...
        is_appropriate = list(hor_spaces.keys()) == [1, 4, 7] \
                         and list(ver_spaces.keys()) == [2, 5, 7]
    return {"horizontal_space_numbers": hor_spaces, "vertical_space_numbers": ver_spaces}


def get_sea_with_ships():
    """Get possible ship placement sea"""
...
def add_spaces(sea: list, row_number: int, spaces: dict):
    """Add spaces between ships into spaces dict"""
